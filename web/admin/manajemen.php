        ...
        <div class="container pd-x-0" id="content">
          ...
          <div class="d-flex align-items-center justify-content-between mg-b-20 mg-sm-b-25 mg-lg-b-25">
            <div class="d-flex align-items-center justify-content-start">
              <h4 class="tx-poppins tx-medium mg-b-0">Manajemen Alumni</h4>
            </div>
            <div>
          ...
          <div class="row row-sm">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mg-b-20 d-flex align-items-center justify-content-start">
              <a href="registrasi.php" class="btn btn-its-3 tx-poppins tx-medium d-flex justify-content-center"><ion-icon name="add" class="mg-y-1 tx-18 mg-r-5"></ion-icon>Buat Akun VIP</a>
            </div>
                    ...
                    <table id="example1" class="table table-hover table-borderless" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th class="table-its wd-40p">Nama</th>
                          <th class="table-its wd-25p">Email</th>
                      ...
                      <tbody>
                        <tr class="bd-b">
                          ...
                          <td class="table-its">
                            <a href="manajemen-detail.php" class="tx-poppins tx-medium tx-color-its3">Cristiano Ronaldo</a>
                          </td>
                          <td class="table-its">
