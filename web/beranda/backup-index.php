      ...
      <div class="content-body mg-t-60">
        <div class="container pd-x-0" id="content">
          <div class="row row-sm">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mg-b-40 mg-md-b-20">
              <div class="d-flex justify-content-between align-items-center ht-md-200">
                ...
                <div>
                  <img src="../../assets/img/myITS-Template.png" class="wd-70 wd-md-150">
                </div>
              </div>
            </div>
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mg-b-10">
                  <div class="card bd-0">
                    <div class="card-body ht-250 pos-relative">
                      ...
                      <span class="badge badge-secondary-transparent tx-12 pd-x-10 pd-y-5 rounded-pill pos-absolute b-30 r-20">Segera hadir</span>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mg-b-10">
                  <div class="card card-hover bd-0">
                    <a href="../ajuan" class="card-hover-line">
                      <div class="card-body ht-250 pos-relative">
                        ...
                        <p class="tx-poppins tx-medium tx-color-01 mg-b-0 tx-15 d-flex align-items-center">Ajuan</p>
                        <p class="tx-13 tx-color-03 mg-b-10">Kelola ajuan Anda.</p>
                        <div class="btn btn-icon btn-its-custom-2 rounded-its-50p d-flex align-items-center pos-absolute b-20 r-20"><ion-icon name="arrow-forward" class="mg-y-2 tx-18"></ion-icon></div>
                      </div>
                    </a>
                  </div>
